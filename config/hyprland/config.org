...
#+end_src
* Input
Settings related to input. Input also contains a subcategory =touchpad=.
...
+ touchpad:natural_scroll :: I don't know why this is "natural", but it's how I prefer scrolling to work.
