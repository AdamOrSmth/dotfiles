;;; doom-dracula-plus-theme.el -*- lexical-binding: t; no-byte-compile: t; -*-
;;; Commentary:
;;; Code:
...
(defcustom doom-dracula-colorful-headers t
...
(def-doom-theme doom-dracula-plus
  ...
  ((bg         '("#282a36" "#262626" "black"))
   ...
   (doc-comments   (if doom-dracula-brighter-comments dark-cyan base5))
   (constants      violet)
   (functions      green)
   (keywords       magenta)
   (methods        green)
  ...
  (((line-number &override) :foreground base5)
   ...
   ;;;; outline <built-in>
   ((outline-1 &override) :inherit 'variable-pitch :foreground level1 :height 1.9 :weight 'light)
   ((outline-2 &override) :inherit 'variable-pitch :foreground level2 :height 1.8 :weight 'light)
   ((outline-3 &override) :inherit 'variable-pitch :foreground level3 :height 1.7 :weight 'light)
   ((outline-4 &override) :inherit 'variable-pitch :foreground level4 :height 1.6 :weight 'light)
   ((outline-5 &override) :inherit 'variable-pitch :foreground level5 :height 1.5 :weight 'light)
   ((outline-6 &override) :inherit 'variable-pitch :foreground level6 :height 1.4 :weight 'light)
   ((outline-7 &override) :inherit 'variable-pitch :foreground level7 :height 1.3 :weight 'light)
   ((outline-8 &override) :inherit 'variable-pitch :foreground level8 :height 1.2 :weight 'light)
   ;;;; org <built-in>
