...
(def-doom-theme doom-nord-plus
  ...
  ((fringe :foreground teal)
   ...
   (org-document-title :inherit 'variable-pitch :height (* doom-nord-plus-variable-font-height-multiplier 1.36) :weight 'bold :foreground blue :slant 'italic)
   (org-level-1 :inherit 'variable-pitch :height (* doom-nord-plus-variable-font-height-multiplier 1.30) :weight doom-nord-plus-variable-font-weight :foreground dark-blue)
   (org-level-2 :inherit 'variable-pitch :height (* doom-nord-plus-variable-font-height-multiplier 1.24) :weight doom-nord-plus-variable-font-weight :foreground blue)
   (org-level-3 :inherit 'variable-pitch :height (* doom-nord-plus-variable-font-height-multiplier 1.18) :weight doom-nord-plus-variable-font-weight :foreground cyan)
   (org-level-4 :inherit 'variable-pitch :height (* doom-nord-plus-variable-font-height-multiplier 1.12) :weight doom-nord-plus-variable-font-weight :foreground teal)
   (org-level-5 :inherit 'variable-pitch :height (* doom-nord-plus-variable-font-height-multiplier 1.06)  :weight doom-nord-plus-variable-font-weight :foreground magenta)
